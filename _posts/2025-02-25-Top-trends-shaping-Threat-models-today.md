---
title: "Top trends shaping Threat models today"
...
{% include elements/figure.html image="/assets/images/post_1_threatmodels/threatmodels.jpg" caption='Attack trends by Italik' %}

Hey there my fellow Cybersecurity geeks, are you also conscious about those sneaky little **malwares** which can **bypass** the basic SOC defences and lurk into your environment like a _**common person on a morning walk?**_
...
{% include elements/figure.html image="/assets/images/post_1_threatmodels/hunt.jpg" caption="'The Dragon Slayer' by Storybird" %}
...
Found something? Great, you’ve caught your culprit! 
Found nothing? Even better—you’ve got new use cases to strengthen your defence shield.

### Final Thoughts

It's a vast ocean. Data is huge and analysts are not enough. It's like _** finding a needle in a haystack**_. Better start looking where probability of threat is high. There is a huge possibility that you won't have to look further. 
